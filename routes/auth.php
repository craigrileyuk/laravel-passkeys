...
Route::middleware('guest')->group(function () {
    ...
    Route::get('passkeys/authenticate', [PasskeyController::class, 'authenticateOptions'])->name('passkeys.authenticate');
    Route::post('passkeys/authenticate',  [PasskeyController::class, 'authenticate'])->name('passkeys.authenticate.login');
});
